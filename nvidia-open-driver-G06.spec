...
# uses %triggerin instead of %post script in order to generate kernel modules
...
%(echo "%triggerin -n %%{-n*}-kmp-%1 -- kernel-default" >> %_builddir/nvidia-kmp-template)
%(cat %_sourcedir/kmp-trigger2.sh             >> %_builddir/nvidia-kmp-template)
